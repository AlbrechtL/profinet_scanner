...
char* decodeVendorID(u_short vID)
{
	...
	case 120: return "B�rkert Werke GmbH";
	...
	case 308: return "Weidm�ller Interface GmbH &amp; Co. KG";
	...
	case 795: return "B�hler Technologies GmbH";
	...
	case 931: return "Br�uer Systemtechnik GmbH";
	case 942: return "Norgren GmbH";
	case 947: return "DUOmetric AG";
	case 949: return "R�mheld GmbH Friedrichsh�tte";
	case 950: return "M&amp;M Software GmbH";
	case 960: return "Layher AG";
	case 961: return "Fraunhofer-Institut f�r Mikroelektronische Schaltungen und Systeme IMS";
	case 970: return "Advantech Europe BV";
	case 973: return "IVG G�hringer";
	...
	case 1214: return "Meister Str�mungstechnik GmbH";
